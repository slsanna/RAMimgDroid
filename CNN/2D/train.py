...
# === Dataset Class (modified for wildcard support) ===
...
def train_memory_regions(mem_regions, model_name, pretrained_val, color, save_dir):
    ...
    malicious_train_apk_indices = list(range(1300))
    malicious_val_apk_indices = list(range(1300, 1500))
    ...
    malicious_train_apks = [malicious_apk_paths[i] for i in malicious_train_apk_indices if i < len(malicious_apk_paths)]
    malicious_val_apks = [malicious_apk_paths[i] for i in malicious_val_apk_indices if i < len(malicious_apk_paths)]
    ...
    # === CustomDataset must accept apk_list argument ===
    ...
    print("Train benign images:", len(train_benign.images))
    print("Train malicious images:", len(train_malicious.images))
